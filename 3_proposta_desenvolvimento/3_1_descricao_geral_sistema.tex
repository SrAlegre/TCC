...
O sistema proposto consiste em uma prótese robótica de mão e braço controlada por sinais de eletromiografia de superfície, com comunicação sem fio entre dois módulos ESP32. A Figura x ilustra a arquitetura geral do sistema, composta pelos seguintes subsistemas:
\begin{itemize}
