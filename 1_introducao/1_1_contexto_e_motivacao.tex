...
\begin{figure}[htbp]
    ...
    \caption{Distribuição percentual dos procedimentos de amputação no SUS por causa.}
    \fonte{\cite{Diretrizes}.}    \label{fig:amputacoes}
\end{figure}

Diante desses dados, evidencia-se a relevância de se desenvolver tecnologias capazes de restaurar a funcionalidade motora e promover a reabilitação dessa população. Nesse sentido, este trabalho propõe o desenvolvimento de uma prótese de membro superior controlada por sinais eletromiografia de superfície (sEMG, do inglês \textit{Surface Electromyography}).